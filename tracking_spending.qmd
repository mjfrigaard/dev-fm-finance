...
```
 ...
 subscription-bar-model — vertical bars showing a $20/month subscription's missed compounding value at years 0, 5, 10, 20, 30 (year-30 bar in red). Added R/Python `subscription_opportunity_cost()` code tabs since the subsection had none.
