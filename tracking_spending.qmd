...
subscription_opportunity_cost(monthly_cost = 20, years = 30) |> fmt_dollar()
```

## Python

Note the exponential is indicated with `**` (not `^`):
...
fmt_dollar(subscription_opportunity_cost(monthly_cost=20, years=30))
```
