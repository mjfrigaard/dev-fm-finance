...
- compound-bar-model — $10,000 growing at 7% across Year 0/5/10/20/30 with a color gradient from mint to red showing acceleration
- fv-series-bar-model — stacked bars separating contributed dollars (teal) from investment gains (mint) at Year 10/20/30 for $500/month contributions
- real-return-bar-model — three side-by-side bars: nominal 7%, inflation 3%, real ~3.9% — making visible what inflation actually costs
